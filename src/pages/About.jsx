...
import { experiences, skills, skillsCategories } from "../constants";
  ...
  return (
    <section className='max-container'>
      ...
      <div className='py-10 flex flex-col'>
        <div className='flex flex-col sm:flex-row sm:items-end justify-between gap-4'>
          <div>
            ...
            <p className='mt-2 text-slate-500 text-sm'>
              Explore technical proficiencies, frameworks, tools, and professional capabilities.
            </p>
          </div>
          <span className='text-xs font-semibold px-3 py-1 bg-blue-50 text-blue-600 rounded-full w-fit border border-blue-100'>
        ...
        {/* Skills Grid */}
        <div className='mt-12 flex flex-wrap gap-x-8 gap-y-10 justify-center sm:justify-start'>
          {filteredSkills.map((skill) => (
            ...
            >
              ...
              >
                <div className={`btn-back rounded-xl ${skill.theme || 'btn-back-blue'}`} />
                ...
                <div 
                  className='absolute -top-12 left-1/2 bg-slate-900 border border-slate-700 text-white text-xs font-bold px-3 py-1 rounded-lg opacity-0 group-hover:opacity-100 group-hover:-top-16 transition-all duration-300 pointer-events-none whitespace-nowrap shadow-xl flex flex-col items-center justify-center z-30'
                  style={{ transform: "translate3d(-50%, 0, 150px)", transformStyle: "preserve-3d" }}
                >
                  <span className='text-white tracking-wide'>{skill.name}</span>
                  <span className='text-[10px] text-slate-400 font-normal'>{skill.type}</span>
                  <div 
              ...
              {/* Skill Name Label below block */}
              <span className='text-xs font-medium text-slate-700 text-center line-clamp-2 leading-tight px-1'>
                {skill.name}
              </span>
            </div>
          ))}
